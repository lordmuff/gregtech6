...
public class WD {
	...
	public static boolean dimAETHER(WorldProvider aProvider) {return MD.AETHER.mLoaded || MD.AETHER_LEGACY.mLoaded && dimAETHER(aProvider, UT.Reflection.getLowercaseClass(aProvider));}
	public static boolean dimAETHER(WorldProvider aProvider, String aProviderClassName) {return MD.AETHER.mLoaded || MD.AETHER_LEGACY.mLoaded && "WorldProviderAether".equalsIgnoreCase(aProviderClassName);}
